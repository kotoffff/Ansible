...
#script for checking last user access data and create summary file about user
# $1 - username
# $2 - tmp dir name
# $3 - {{ansible_hostname}}
...
do 
  for i in $(grep -i $(echo $a | awk '{print $2}') /var/log/auth.log* | cut '-d:' -f2- | awk '{print $1,$2,$3}')
  do 
