...
#script for checking last user access data and create summary file about user on RHEL5 and RHEL6 OS
# $1 - username
# $2 - tmp dir name
# $3 - {{ansible_hostname}}
...
do 
  for i in $(grep -i "Accepted publickey for $USERNAME" /var/log/secure* | cut '-d:' -f2- | awk '{print $1,$2,$3}')
  do 
