...
#script for checking last user access data and create summary file about user on SLES 12 OS
# $1 - username
# $2 - tmp dir name
# $3 - {{ansible_hostname}}
...
do 
  latest_access_date=$(grep -i $(echo $a | awk '{print $2}') /var/log/messages* | cut '-d:' -f2- | tr T " " | tr . " " | awk '{print $1,$2}' | tr " " _  | sort | tail -n 1)
